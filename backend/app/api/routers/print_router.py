...
.sale-footer-info {{ font-family: 'Cairo', sans-serif; font-size: {f("7pt","6pt")}; color: #333; position: fixed; bottom: 0; left: 0; right: 0; background: white; }}
.body {{ padding-bottom: 30pt !important; }}
