...
async def create_category(data: dict, db: AsyncSession = Depends(get_db), _=Depends(require_role("admin"))):
...
async def update_category(cat_id: uuid.UUID, data: dict, db: AsyncSession = Depends(get_db), _=Depends(require_role("admin"))):
...
async def get_permissions(user_id: uuid.UUID, db: AsyncSession = Depends(get_db), _=Depends(require_role("admin"))):
...
async def update_permissions(user_id: uuid.UUID, data: dict, db: AsyncSession = Depends(get_db), _=Depends(require_role("admin"))):
