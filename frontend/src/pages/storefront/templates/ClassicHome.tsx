...
export default function ClassicHome(data: HomeData) {
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      <StorefrontNav />
      <StorefrontHero products={data.items} totalProducts={data.totalProducts} categoryCount={data.catList.length} variant="classic" title={data.heroTitle} subtitle={data.heroSubtitle} />
